const CACHE='win-win-4.7';
const CORE=['./','./index.html','./styles.css?v=4.7','./app.js?v=4.7','./manifest.webmanifest','./version.json','./apple-touch-icon.png','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
