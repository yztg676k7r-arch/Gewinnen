const CACHE='win-win-5.3';
const CORE=['./','./index.html','./styles.css?v=5.3','./app.js?v=5.3','./manifest.webmanifest','./version.json','./apple-touch-icon.png','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
