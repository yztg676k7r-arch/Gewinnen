const CACHE='win-win-4.5.2';
const CORE=['./','./index.html','./styles.css?v=4.5.2','./app.js?v=4.5.2','./manifest.webmanifest','./version.json','./apple-touch-icon.png','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
const DATA_PATHS=['./data/contests.json','./contests.json','./data/sources.json','./sources.json'];
