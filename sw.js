const CACHE='win-win-4.6.2';
const CORE=['./','./index.html','./styles.css?v=4.6.2','./app.js?v=4.6.2','./manifest.webmanifest','./version.json','./apple-touch-icon.png','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
