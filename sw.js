const CACHE='win-win-4.6.1';
const CORE=['./','./index.html','./styles.css?v=4.6.1','./app.js?v=4.6.1','./manifest.webmanifest','./version.json','./apple-touch-icon.png','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
const DATA_PATHS=['./data/catalog-4.6.1.json','./catalog-4.6.1.json','./data/contests.json','./contests.json','./data/sources.json','./sources.json'];
